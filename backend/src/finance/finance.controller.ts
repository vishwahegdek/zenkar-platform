import { Controller, Get, Post, Body, Param, UseGuards, Query, ValidationPipe, ParseIntPipe, Put, Req } from '@nestjs/common';
...
export class FinanceController {
  ...
  createParty(
      @Req() req, 
      @Body(ValidationPipe) dto: CreateFinancePartyDto
  ) {
