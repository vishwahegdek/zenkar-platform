-- Modified migration script to fix production drift
-- Based on 20251212055845_add_auditing_fixed
-- SKIPS adding "is_quick_sale" to "orders" as it already exists.

-- AlterTable
ALTER TABLE "customers" ADD COLUMN     "contact_id" INTEGER;

-- AlterTable
-- MODIFIED: Split into separate statements and removed is_quick_sale
ALTER TABLE "orders" ADD COLUMN     "created_by_id" INTEGER;
-- ALTER TABLE "orders" ADD COLUMN     "is_quick_sale" BOOLEAN NOT NULL DEFAULT false; -- SKIPPED
ALTER TABLE "orders" ADD COLUMN     "updated_by_id" INTEGER;
